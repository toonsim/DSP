...
N_q = 3; % No of bits in 1 QAM Symbol
...
L_d = nb_data_frames; % No of frames per data packet
...
%% Generate OFDM Stream
Tx = [training_ofdm;ofdm_mod(qamStream,CP_length,nb_data_frames,N_valid,bad_carriers)];
...
[rxQamStream,H_est] = ofdm_demod_lms(Rx, training_block, N, L_t,L_d,CP_length,nb_added,N_q,bad_carriers,unique(qamStream));
